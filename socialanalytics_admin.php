				...
				<tbody>
					<tr valign="top">
						...
						<td>
							...
							<input type="checkbox" name="social_network_google_plus" value="google_plus" id="google_plus" <?php if ($social_network_google_plus != "google_plus") {echo "unchecked";} else {echo "checked";} ?>> <label for="google_plus"><?php _e("Google Plus", 'social_analytics'); ?></label>
						</td>
					</tr>
				</tbody>
			</table>
